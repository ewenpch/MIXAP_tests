...
Add text to the augmentation
    ...
    Input Text    xpath=//input[contains(@class, 'ant-input css-j9bb5n ant-input-outlined ds-modal__input') and @placeholder='Describe the image…']    Generate an image of a cat and a dog playing together in the park.
